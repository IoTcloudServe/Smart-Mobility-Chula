...
sudo ovs-ofctl add-flow br0 arp,priority=100,in_port=1,arp_spa=$raspi4_ip,arp_tpa=$raspi1_ip,actions=LOCAL
...
sudo ovs-ofctl add-flow br0 ip,priority=100,in_port=1,nw_src=$raspi4_ip,nw_dst=$raspi1_ip,actions=LOCAL
...
sudo ovs-ofctl add-flow br0 arp,priority=90,in_port=1,dl_src=$raspi2,actions="resubmit(,3)"
sudo ovs-ofctl add-flow br0 arp,priority=90,in_port=1,dl_src=$gw1,actions="resubmit(,4)"
sudo ovs-ofctl add-flow br0 ip,priority=90,in_port=1,dl_src=$gw1,actions="resubmit(,4)"
sudo ovs-ofctl add-flow br0 ip,priority=90,in_port=1,dl_src=$raspi2,actions="resubmit(,3)"
