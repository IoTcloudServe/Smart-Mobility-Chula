...
#    with open('/home/raspi2/Downloads/' + current_date + '/' + 'pi2 gw switch list' + current_time + '.txt', 'w') as fp:
    with open('/home/raspi2/Downloads/pi2 gw switch list' + current_time + '.txt', 'w') as fp:
