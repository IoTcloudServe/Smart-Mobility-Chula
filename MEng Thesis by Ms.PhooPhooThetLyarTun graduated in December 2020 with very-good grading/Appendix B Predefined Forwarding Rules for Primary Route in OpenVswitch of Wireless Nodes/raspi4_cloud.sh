...
#Receive the incoming traffic to Raspi 4 (10.0.0.4) from Raspi 1, Raspi 5
...
sudo ovs-ofctl add-flow br0 ip,priority=100,in_port=1,nw_src=$raspi1_ip,actions=LOCAL
...
sudo ovs-ofctl add-flow br0 arp,priority=100,in_port=1,arp_spa=$raspi1_ip,actions=LOCAL


#Send the packet from Raspi 4 to gw1,pi1
