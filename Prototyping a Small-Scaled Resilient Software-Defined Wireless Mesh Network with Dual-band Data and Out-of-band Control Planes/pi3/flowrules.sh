...
sudo ovs-vsctl set bridge br0 other-config:datapath_id=1000000000000003
sudo ovs-vsctl set bridge br1 other-config:datapath_id=2000000000000003
sudo ovs-vsctl add-port br0 wlan0 -- set interface wlan0 ofport_request=1
sudo ovs-vsctl add-port br1 wlx24fd52279af8 -- set interface wlx24fd52279af8 ofport_request=2
